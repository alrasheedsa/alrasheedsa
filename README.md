...
|:---|:---|:---|
| 🎓 **Tuwaiq Capstone** *(In Progress)* | Full-stack enterprise web application with Java, Spring Boot, AI integration, and AWS cloud deployment. | `Java` `Spring Boot` `Spring Security` `Hibernate` `JPA` `AWS` `AI APIs` |
